    ...
    public partial class PCHUBForm : Form
    {
        ...
        public PCHUBForm()
        {
            ...
            trayIcon = new NotifyIcon
            {
                ...
                Text = "PcHub" + About.AboutClass.BuildInfo, // NAME
                Visible = false
            };
        ...
        {
            OpenClassSpace.OpenClass.Open.ShowForm<ChoiceSpace.PerfmonOrTaskmgr>();
        }

        public void aboutToolStripMenuItem_Click(object sender, EventArgs e)
        {
            About.AboutClass.Open.Build(); // откроется информация
        }

        private void TxtWriter_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<Writer>(); // откроется писатель (writer)
        }

        private void Taskkiller_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<TaskKiller>(); // Откроется форма TaskKiller.cs
        }

        private void FileExplorer_Click(object? sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<ChoiceSpace.BrowserExplorerOrJustExplorerDotExe>(); // Откроется форма TaskKiller.cs
        }

        private void btnLocalUser_Click(object? sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<LocalUserSpace.LocalUserForm>(); // добавление локального пользователя
        }

        private void btnbuildhelp_Click(object sender, EventArgs e)
        {
            About.AboutClass.Open.Build();
        }
        ...
        {
            OpenClassSpace.OpenClass.Open.ShowForm<PowerSpace.PowerManagement>();
        }

        public void btnHostsFile_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<HostsSpace.HostsFile>();
        }

        public void btnPowerShellPolicyManager_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<PowerShellPolicyReset>();
        }

        private void btnTools_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<WinToolsForm>();
        }

        private void btnFileDelete_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<Delete_files>();
        }

        private void btnUninstaller_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<UnInstaller>();
        }

        private void runToolStripMenuItem_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<ProccesStartForm>();
        }

        private void UnlockSystem_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<SystemUnlocker>();
        }

        private void btnBlockProcessForm_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<BlockProcessForm>();
        }
        ...
        {
            OpenClassSpace.OpenClass.Open.ShowForm<HostsSpace.BlockWebSite>();
        }

        private void btnUtilMan_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<UtilManForm>();
        }

        private void btnCmdLine_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<CmdLineForm>();
        }

        private void btnMyProgramList_Click(object sender, EventArgs e)
        {
            OpenClassSpace.OpenClass.Open.ShowForm<MyProgramList>();
        }
    }
}
